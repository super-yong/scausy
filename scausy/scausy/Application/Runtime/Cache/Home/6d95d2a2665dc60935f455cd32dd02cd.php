					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav " id="mytab">
								...
								<li ><a href="/scausy/home/index/news" >通 &nbsp;知</a></li>
								<li><a href="/scausy/home/index/activity" data-toggle="tab">活动风采</a></li>
								<li class="active"><a href="/scausy/index.php/home/index/exemplar">模范频道</a></li>
					...
					<div class="col-md-12">
						<div class="page2_news">
							<div class="post_head text-center">
								...
								<div class="post_meta">
									<span class="">
										作者：<a href="#"><?php echo ($list[0]["author"]); ?></a>
							    	</span> &nbsp;&bull;
									<time><?php echo (date('Y-m-d H:i',$list[0]["createtime"])); ?></time>
								</div>
							</div>
						
							<div class="post_content">
								<!--<blockquote>-->
								<?php echo (stripslashes(htmlspecialchars_decode($list[0]["body"]))); ?>
								<!--</blockquote>-->
							</div>
