		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-2">
				<div class="container"  style="margin: 0 10%;">
					<h2 style="border-bottom:1px solid darkgrey ;padding-bottom: 10px;">编辑</h2>
					<!--提交发表征文表单-->
					<form class="form-horizontal" action="/scausy/home/exemplar/add" method="post">
			            ...
			            <div style="border: 1px dashed gray;padding: 10px 20px;width: 800px;"class="col-md-8">
						    ...
						    <div class="form-group">
						        ...
						        <div class="col-md-4">
									<button id="picture_button" type="button"  onclick="upImage();"> <img id="img_id" src="http://7xlp0l.com1.z0.glb.clouddn.com/14421283243.png" alt="请选择图片" class="addtr" style="width: 90px;"></button>
			                        <input type="type" style="display:none;" name="picture_url" value="http://7xlp0l.com1.z0.glb.clouddn.com/14421283243.png" id="picture_id">
							    </div>
						    </div>
						    <div class="form-group">
						    	<label class="col-md-2 control-label">作者:</label>
						        <div class="col-md-4">
								    <input type="text" class="form-control" id="author" name="author" placeholder="如张三" value="">
							    </div>
						    </div>
						    <div class="form-group">
						    	<label class="col-md-2 control-label">主题:</label>
						        <div class="col-md-4">
								    <input type="text" class="form-control" id="subject" name="subject" placeholder="如我与诚信" value="">
							    </div>
							    <label class="col-md-2 control-label">类型:</label>
						        <div class="col-md-4">
								    <input type="text" class="form-control" id="briefIntroduction" name="tag" placeholder="征文/采访" ></input>
							    </div>
						    ...
						    <div class="form-group">
						    	...
						    	<div class="col-md-10">
								    <textarea class="form-control" rows="2" id="briefIntroduction" placeholder="作者简介" name="brief_introduction"></textarea>
							    </div>
						    </div>
			            </div>
			            <div class="col-md-offset-8"style="margin-top: 400px;">
						   <button type="submit" class="btn btn-lg btn-success" style="margin: 20px -25px;">发 表</button>
						</div>
